<main>
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo site_url('kinerjapetugas/edit') ?>" method="post">
                    <input type="hidden" name="id_kinerja" value="<?=$kinerja->id_kinerja;?>" required />
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_petugas" class="form-control chosen-select <?php echo form_error('id_petugas') ? 'is-invalid':'' ?>" required>
                            ...
                            <?php foreach ($petugas as $p): ?>
                                <option value="<?=$p->id_petugas?>" <?=($p->id_petugas == $kinerja->id_petugas) ? 'selected' : ''?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control <?php echo form_error('total_kasus') ? 'is-invalid':'' ?>"
                            type="number" name="total_kasus" value="<?=$kinerja->total_kasus;?>" 
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control <?php echo form_error('kasus_selesai') ? 'is-invalid':'' ?>"
                            type="text" name="kasus_selesai" value="<?=$kinerja->kasus_selesai;?>" 
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control <?php echo form_error('rata_penangan') ? 'is-invalid':'' ?>"
                            type="text" name="rata_penangan" value="<?=$kinerja->rata_penangan;?>" 
                            placeholder="Rata-rata waktu penanganan" required />
                        <div class="invalid-feedback">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control <?php echo form_error('tersangka') ? 'is-invalid':'' ?>"
                            type="text" name="tersangka" value="<?=$kinerja->tersangka;?>" 
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control <?php echo form_error('nilai_kinerja') ? 'is-invalid':'' ?>"
                            type="number" min="0" max="100" name="nilai_kinerja" value="<?=$kinerja->nilai_kinerja;?>" 
