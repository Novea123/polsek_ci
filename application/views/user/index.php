	...
	<div class="container-fluid">
		...
		<div class="card mb-4">
			<div class="card-header">
				<a href="<?php echo site_url('user/add') ?>s" class="btn btn-primary btn-icon-split">
			...
			<table class="table table-striped table-bordered table-hover" id="tabelkelas" width="100%" cellspacing="0">
				...
				<tbody>								
					...
					echo "<tr>
							...
							<td>
							<div>
							<a href=".base_url('user/getedit/'. $user->id)." class='btn btn-sm btn-warning'><i class='fas fa-edit'></i> Edit</a>
